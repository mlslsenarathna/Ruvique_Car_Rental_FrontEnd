                    ...
                    <div className="container">
                        <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                            ...
                            <ul className="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                                <li>
                                    <a href="/carowner-Home" className="nav-link text-my-color">
                                        <svg className="bi d-block mx-auto mb-1" width="24" height="24"><use xlinkHref="#home"></use></svg>
                                        Homes
                                    </a>
                                </li>
                                <li>
                                    <a href="/carowner-dashboard" className="nav-link text-my-color">
                                ...
                                <li>
                                    <a href="/carowner-dashboard/vehicles" className="nav-link text-my-color">
                                        <svg className="bi d-block mx-auto mb-1" width="24" height="24"><use xlinkHref="#grid"></use></svg>
                                        Products
                                    </a>
                                </li>
                                <li>
                                    <a href="/carowner-profile" className="nav-link text-my-color">
